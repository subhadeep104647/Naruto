    ...
    <>
        ...
        >
          ...
          >
            <p className="text-green-300 text-lg tracking-wide leading-8">
              Rock Lee is a shinobi of Konohagakure and a student of Might Guy.
              Unable to use ninjutsu or genjutsu, Lee dedicated himself
              entirely to taijutsu through relentless effort and discipline.
              His determination, unwavering spirit, and mastery of the Eight
              Inner Gates allowed him to overcome seemingly impossible odds,
              making him one of the most inspirational ninja in the Hidden
              Leaf Village.
            </p>
          </motion.div>
        </motion.div>
      ...
      <div className="flex flex-row justify-between items-center">
        ...
        <div>
          <Link to="/Lee2">
            <motion.h1
              className="bg-gradient-to-r from-green-400 via-lime-300 to-emerald-500 bg-clip-text text-transparent text-xl md:text-2xl font-serif tracking-[8px]"
