    ...
    <>
        ...
        >
          ...
          >
            <p className="text-purple-300 text-lg tracking-wide leading-8">
              Sasuke Uchiha is one of the strongest shinobi in history and the
              last surviving member of Konohagakure's prestigious Uchiha Clan.
              Driven by revenge after the tragedy of his clan, Sasuke walked a
              dark path in search of power. Through countless battles and
              hardships, he eventually found redemption and became one of the
              Hidden Leaf's greatest protectors alongside Naruto Uzumaki.
            </p>
          </motion.div>
        </motion.div>
      ...
      <div className="flex flex-row justify-between items-center">
        ...
        <div>
          <Link to="/Sasuke2">
            <motion.h1
              className="bg-gradient-to-r from-purple-500 via-indigo-400 to-blue-500 bg-clip-text text-transparent text-xl md:text-2xl font-serif tracking-[8px]"
