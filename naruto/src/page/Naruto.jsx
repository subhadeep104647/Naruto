...
const Naruto = () => {
  return (
    ...
    <div className='flex flex-row justify-between items-center'>
        ...
        <div><Link to='/Naruto2'>
           <motion.h1
                   className="bg-gradient-to-r from-orange-400 via-yellow-300 to-orange-600 bg-clip-text text-transparent text-xl md:text-2xl font-serif tracking-[8px] text-shadow-2xl"
