...
const Nav = () => {
  return (
    <div className="rounded-full px-8 py-3 bg-white/5 backdrop-blur-2xl flex gap-8 items-center justify-center border-2 border-gray-300/20 text-white text-sm font-semibold tracking-wider">
