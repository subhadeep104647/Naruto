...
const ShisuiStat = ({
  ...
  >
    ...
    {/* Kotoamatsukami */}
    <div className="mt-3">
      <p className="text-cyan-300 text-xs mb-1">Kotoamatsukami</p>

      <div className="h-2 bg-gray-800 rounded-full overflow-hidden">
        <motion.div
          initial={{ width: 0 }}
          animate={{ width: kotoamatsukami }}
          transition={{
            delay: delay + 1.1,
            duration: 1.5,
          }}
      ...
      <p className="text-xs text-gray-400 mt-1">{kotoamatsukami}</p>
    </div>
  </motion.div>
);
  ...
  return (
    <div className="flex flex-col items-center justify-between h-full gap-20">
      ...
      <div className="flex flex-row items-center justify-center w-full mt-5">
        ...
        <motion.h1
          className="bg-gradient-to-r from-green-400 via-emerald-300 to-cyan-400 bg-clip-text text-transparent text-2xl md:text-4xl font-serif tracking-[8px]"
